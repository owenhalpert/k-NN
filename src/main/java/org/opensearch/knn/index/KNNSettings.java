...
public class KNNSettings {
    ...
    public static final String KNN_DOWNLOAD_FILENAME = "knn.download.filename";
    public static final String KNN_DOWNLOAD_BLOBPATH = "knn.download.blobpath";
    public static final String KNN_FORCE_DOWNLOAD = "knn.force.download";
    ...
    public Boolean getForceDownload() {
        return KNNSettings.state().getSettingValue(KNNSettings.KNN_FORCE_DOWNLOAD);
    }
    ...
    public static final Setting<String> KNN_DOWNLOAD_FILENAME_SETTING = Setting.simpleString(KNN_DOWNLOAD_FILENAME, Dynamic, NodeScope);

    public static final Setting<String> KNN_DOWNLOAD_BLOBPATH_SETTING = Setting.simpleString(KNN_DOWNLOAD_BLOBPATH, Dynamic, NodeScope);

    public static final Setting<Boolean> KNN_FORCE_DOWNLOAD_SETTING = Setting.boolSetting(KNN_FORCE_DOWNLOAD, false, Dynamic, NodeScope);
    ...
    private Setting<?> getSetting(String key) {
        ...
        if (KNN_DOWNLOAD_FILENAME.equals(key)) {
            return KNN_DOWNLOAD_FILENAME_SETTING;
        }

        if (KNN_FORCE_DOWNLOAD.equals(key)) {
            return KNN_FORCE_DOWNLOAD_SETTING;
        }

        if (KNN_DOWNLOAD_BLOBPATH.equals(key)) {
            return KNN_DOWNLOAD_BLOBPATH_SETTING;
        }
    ...
    public List<Setting<?>> getSettings() {
        List<Setting<?>> settings = Arrays.asList(
            ...
            KNN_FORCE_DOWNLOAD_SETTING,
            KNN_DOWNLOAD_FILENAME_SETTING,
            KNN_DOWNLOAD_BLOBPATH_SETTING
        );
    ...
    public String getDownloadFileName() {
        return KNNSettings.state().getSettingValue(KNNSettings.KNN_DOWNLOAD_FILENAME);
    }

    public String getDownloadBlobPath() {
        return KNNSettings.state().getSettingValue(KNNSettings.KNN_DOWNLOAD_BLOBPATH);
    }
