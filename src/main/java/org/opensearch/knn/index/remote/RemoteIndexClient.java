...
public class RemoteIndexClient {
    ...
    */
    protected static String getValueFromResponse(String responseBody, String key) throws JsonProcessingException {
     ...
     */
    private void authenticateRequest(HttpUriRequestBase request) {
